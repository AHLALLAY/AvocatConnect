                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <div class="flex space-x-4">
                            <a href="/login" class="bg-[#d9910d] text-[#0d0d0d] px-6 py-2 rounded-lg hover:bg-[#bf9e60] transition-colors duration-300 shadow-md">Connexion</a>
                            <a href="/subscribe" class="bg-[#bf9e60] text-[#0d0d0d] px-6 py-2 rounded-lg hover:bg-[#d9910d] transition-colors duration-300 shadow-md">S'inscrire</a>
                        </div>
                    </div>
